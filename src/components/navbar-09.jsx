      ...
      <div className="mx-auto flex size-full max-w-full items-center justify-between">
        ...
        <div className="absolute hidden h-screen overflow-auto border-b border-scheme-border bg-scheme-background px-[5%] pt-4 pb-24 md:pb-0 lg:static lg:ml-6 lg:flex lg:h-auto lg:flex-1 lg:items-center lg:justify-between lg:border-none lg:bg-none lg:px-0 lg:pt-0">
            ...
            >
              ...
              <AnimatePresence>
                <motion.nav
                  ...
                  className="d top-full bottom-auto left-0 w-full max-w-full min-w-full overflow-hidden bg-scheme-background lg:absolute lg:w-screen lg:border-b lg:border-scheme-border lg:px-[5%] lg:[--height-close:auto]"
                >
                  <div className="mx-auto flex size-full max-w-full items-center justify-between">
                      ...
                      <div className="grid flex-1 grid-cols-1 content-start items-start gap-x-8 gap-y-2 py-4 md:grid-cols-2 md:gap-y-6 md:py-8 lg:auto-cols-fr lg:grid-cols-4 lg:content-stretch lg:items-stretch lg:gap-y-0">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="text-small hidden md:block">
                              Navigate through innovative digital solutions
                            </p>
                          </div>
                        </Link>
                        <Link
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="text-small hidden md:block">
                              Explore cutting-edge software engineering projects
                            </p>
                          </div>
                        </Link>
                        <Link
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="text-small hidden md:block">
                              Custom technology solutions for modern challenges
                            </p>
                          </div>
                        </Link>
                        <Link
                  ...
                  <div className="relative mb-6 flex w-full flex-col items-start justify-between p-6 sm:items-center lg:mb-0 lg:flex-row lg:px-0 lg:py-3">
                    ...
                    <div className="relative z-10 mr-auto flex flex-col gap-y-4 sm:mx-auto sm:grid sm:auto-cols-fr sm:grid-cols-[max-content_max-content] sm:gap-x-1">
                      <p>Seeking tech opportunities</p>
          ...
          <div className="flex items-center gap-4">
            <Button title="Hire" variant="secondary" size="sm">
              Hire
            </Button>
            <Button title="Explore" size="sm">
              Explore
            </Button>
          </div>
        </div>
        ...
        >
          ...
          >
            <div className="flex flex-col">
              <Link to="/" className="text-medium block py-3">
                Home
              </Link>
              <Link to="/about" className="text-medium block py-3">
                About
              </Link>
              <Link to="/projects" className="text-medium block py-3">
                Projects
              </Link>
              <div>
                <button
                        ...
                        <div className="grid flex-1 grid-cols-1 content-start items-start gap-x-8 gap-y-2 py-4 md:grid-cols-2 md:gap-y-6 md:py-8 lg:auto-cols-fr lg:grid-cols-4 lg:content-stretch lg:items-stretch lg:gap-y-0">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Services</h5>
                              <p className="text-small hidden md:block">
                                Custom technology solutions for your needs
                              </p>
                            </div>
                          </Link>
                          <Link
