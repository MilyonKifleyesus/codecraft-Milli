    ...
    <section className="relative px-[5%] py-16 md:py-24 lg:py-28">
      <div className="relative z-10 container">
        <div className="grid grid-cols-1 gap-x-12 gap-y-5 md:grid-cols-2 lg:gap-x-20">
          <div>
            <p className="mb-3 font-semibold text-white md:mb-4">Code</p>
          ...
          <div className="mx-[7.5%] md:mt-48">
            <p className="text-medium text-white">
              Every line of code tells a story. I build robust web applications
              that solve real-world problems with clean, efficient design.
            </p>
